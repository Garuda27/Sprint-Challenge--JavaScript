...
*/
const animalNames = [];
let animals=zooAnimals.forEach(obj => {
...
*/
const lowerPopulation = zooAnimals.filter(animals => animals.population < 5)
...
*/
const populationTotal = zooAnimals.reduce((total, animalPop) => total + animalPop.population,0)
